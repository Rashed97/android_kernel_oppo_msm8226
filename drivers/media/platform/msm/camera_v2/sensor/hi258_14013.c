...
#include "msm_cci.h"
#include "msm_camera_io_util.h"
#define HI258_14013_SENSOR_NAME "hi258_14013"
#define PLATFORM_DRIVER_NAME "msm_camera_hi258_14013"
#include <mach/device_info.h>
#define DEVICE_VERSION_14013_F	"Hi258"
#define DEVICE_MANUFACUTRE_14013_F	"Hynix"
...
DEFINE_MSM_MUTEX(hi258_14013_mut);
static struct msm_sensor_ctrl_t hi258_14013_s_ctrl;

static struct msm_sensor_power_setting hi258_14013_power_setting[] =
{
	{
...
static struct msm_camera_i2c_reg_conf hi258_14013_uxga_settings[] = {
/* 2M FULL Mode */
{0x03, 0x00},
...
{0x03,0x00},
{0x01, 0x00},  // HI258_14013_Sleep_Mode

};

//zhaozhengtao modify for ROM Gesture Recognition 20140419
#if 1
static struct msm_camera_i2c_reg_conf hi258_14013_vga_settings[] = {
/* 720*480**24-30fps */
{0x03, 0x00},
{0x01, 0x01},  // HI258_Sleep_Mode
{0x11, 0x97},
...
#endif
static struct msm_camera_i2c_reg_conf hi258_14013_start_settings[] = {
	{0x03, 0x00},
	{0x01, 0x00},
};

static struct msm_camera_i2c_reg_conf hi258_14013_stop_settings[] = {
	{0x03, 0x00},
	{0x01, 0x01},
};

static struct msm_camera_i2c_reg_conf hi258_14013_recommend_settings[] = {
	{0x01, 0x01}, //sleep on
{0x01, 0x03}, //sleep off
{0x01, 0x01}, //sleep on
// PAGE 20
...
{0x74, 0x05}, //White Protection Offset Outdoor
...
{0xa6, 0x10}, //Dark Lclip_N
{0xa7, 0x10}, //Dark Lclip_P
...
static struct v4l2_subdev_info hi258_14013_subdev_info[] = {
	{
...
static struct msm_camera_i2c_reg_conf hi258_14013_svga_settings[] = {
{0x03, 0x00},
{0x10, 0x90},
{0xd2, 0x05},
{0x03, 0x48},
...
static struct msm_camera_i2c_reg_conf hi258_14013_sleep_settings[] = {
...
static struct msm_camera_i2c_reg_conf HI258_14013_reg_saturation[11][3] = {
	{
		{0x03, 0x10},
		{0x61, 0x1c},
		{0x62, 0x1c},//-5
...
static struct msm_camera_i2c_reg_conf HI258_14013_reg_contrast[11][3] = {
	{
		{0x03, 0x10},
		{0x13, 0x03},
		{0x48, 0x60},
...
static struct msm_camera_i2c_reg_conf HI258_14013_reg_sharpness[7][9] = {
	{
		{0x03, 0x13},
		{0x81, 0x07}, //Sharp2D Clip/Limit
...
static struct msm_camera_i2c_reg_conf HI258_14013_reg_iso[7][3] = {
	/* auto */
	{
		{0x03, 0x20},
		{0x10, 0x9c},
...
static struct msm_camera_i2c_reg_conf HI258_14013_reg_exposure_compensation[5][2] = {
	/* -2 */
	{
		{0x03, 0x10},
		{0x40, 0xa4},
...
static struct msm_camera_i2c_reg_conf HI258_14013_reg_antibanding[][2] = {
	/* OFF */
	{
		{0x03, 0x20},
		{0x10, 0xcc},
...
static struct msm_camera_i2c_reg_conf HI258_14013_reg_effect_normal[] = {
	/* normal: */
	{0x03, 0x20},
	{0x28, 0xf7},
	{0x03, 0x10},
...
static struct msm_camera_i2c_reg_conf HI258_14013_reg_effect_black_white[] = {
	/* B&W: */
	{0x03, 0x20},
	{0x28, 0xf7},
	{0x03, 0x10},
...
static struct msm_camera_i2c_reg_conf HI258_14013_reg_effect_negative[] = {
	/* Negative: */
	{0x03, 0x20},
	{0x28, 0xf7},
	{0x03, 0x10},
...
static struct msm_camera_i2c_reg_conf HI258_14013_reg_effect_old_movie[] = {
	/* Sepia(antique): */
	{0x03, 0x20},
	{0x28, 0xf7},
	{0x03, 0x10},
...
static struct msm_camera_i2c_reg_conf HI258_14013_reg_effect_solarize[] = {
	{0x03, 0x20},
	{0x28, 0xf7},
	{0x03, 0x10},
	{0x11, 0x0b},
...
static struct msm_camera_i2c_reg_conf HI258_14013_reg_scene_auto[] = {
	/* <SCENE_auto> */
	{0x03, 0x20},
	{0x10, 0x9c},
};

static struct msm_camera_i2c_reg_conf HI258_14013_reg_scene_portrait[] = {
...
static struct msm_camera_i2c_reg_conf HI258_14013_reg_scene_landscape[] = {
...
static struct msm_camera_i2c_reg_conf HI258_14013_reg_scene_night[] = {
	/* <SCENE_NIGHT> */
	{0x03, 0x20},
	{0x10, 0x1c},
	{0x10, 0x9c},
...
static struct msm_camera_i2c_reg_conf HI258_14013_reg_wb_auto[] = {
	/* Auto: */
	{0x03, 0x22},
	{0x11, 0x2e},
	{0x83, 0x58},
...
static struct msm_camera_i2c_reg_conf HI258_14013_reg_wb_sunny[] = {
	/* Sunny: */
	{0x03, 0x22},
	{0x11, 0x28},
	{0x80, 0x33},
...
static struct msm_camera_i2c_reg_conf HI258_14013_reg_wb_cloudy[] = {
	/* Cloudy: */
	{0x03, 0x22},
	{0x11, 0x28},
	{0x80, 0x49},
...
static struct msm_camera_i2c_reg_conf HI258_14013_reg_wb_office[] = {
	/* Office: */
	{0x03, 0x22},
	{0x11, 0x2e},
	{0x83, 0x58},
...
static struct msm_camera_i2c_reg_conf HI258_14013_reg_wb_home[] = {
	/* Home: */
	{0x03, 0x22},
	{0x11, 0x28},
	{0x80, 0x29},
...
static const struct i2c_device_id hi258_14013_i2c_id[] = {
	{HI258_14013_SENSOR_NAME, (kernel_ulong_t)&hi258_14013_s_ctrl},
	{ }
};

static int32_t msm_hi258_14013_i2c_probe(struct i2c_client *client,
	   const struct i2c_device_id *id)
{
	int rc;
	rc = msm_sensor_i2c_probe(client, id, &hi258_14013_s_ctrl);
	CDBG("%s:%d\n", __func__, __LINE__);
	   return rc;
}

static struct i2c_driver hi258_14013_i2c_driver = {
	.id_table = hi258_14013_i2c_id,
	.probe  = msm_hi258_14013_i2c_probe,
	.driver = {
		.name = HI258_14013_SENSOR_NAME,
	},
};

static struct msm_camera_i2c_client hi258_14013_sensor_i2c_client = {
	.addr_type = MSM_CAMERA_I2C_BYTE_ADDR,
};

static const struct of_device_id hi258_14013_dt_match[] = {
	{.compatible = "qcom,hi258_14013", .data = &hi258_14013_s_ctrl},
	{}
};

MODULE_DEVICE_TABLE(of, hi258_14013_dt_match);

static struct platform_driver hi258_14013_platform_driver = {
	.driver = {
		.name = "qcom,hi258_14013",
		.owner = THIS_MODULE,
		.of_match_table = hi258_14013_dt_match,
	},
};

static void hi258_14013_i2c_write_table(struct msm_sensor_ctrl_t *s_ctrl,
...
static uint32_t hi258_14013_get_exp(struct msm_sensor_ctrl_t *s_ctrl)
{
	uint32_t rc = 0, val=0;
	uint32_t exp = 0;
...
static uint32_t hi258_14013_get_iso(struct msm_sensor_ctrl_t *s_ctrl)
{
	uint32_t val = 0, rc=0;
...
static int32_t hi258_14013_sensor_power_down(struct msm_sensor_ctrl_t *s_ctrl)
{
	hi258_14013_i2c_write_table(s_ctrl, &hi258_14013_sleep_settings[0],
		ARRAY_SIZE(hi258_14013_sleep_settings));
	return msm_sensor_power_down(s_ctrl);
}

static int32_t hi258_14013_platform_probe(struct platform_device *pdev)
{
	int32_t rc;
	const struct of_device_id *match;
	CDBG("%s:%d\n", __func__, __LINE__);
	match = of_match_device(hi258_14013_dt_match, &pdev->dev);
	rc = msm_sensor_platform_probe(pdev, match->data);
      if(!rc)
       {
        register_device_proc("f_camera", DEVICE_VERSION_14013_F, DEVICE_MANUFACUTRE_14013_F);
       }
	return rc;
}

static int __init hi258_14013_init_module(void)
{
	int32_t rc;
	CDBG("%s:%d\n", __func__, __LINE__);

	rc = platform_driver_probe(&hi258_14013_platform_driver,
		hi258_14013_platform_probe);
	if (!rc)
		return rc;
	return i2c_add_driver(&hi258_14013_i2c_driver);
}

static void __exit hi258_14013_exit_module(void)
{
	pr_info("%s:%d\n", __func__, __LINE__);
	if (hi258_14013_s_ctrl.pdev) {
		msm_sensor_free_sensor_data(&hi258_14013_s_ctrl);
		platform_driver_unregister(&hi258_14013_platform_driver);
	} else
		i2c_del_driver(&hi258_14013_i2c_driver);
	return;
}

static int32_t hi258_14013_sensor_match_id(struct msm_sensor_ctrl_t *s_ctrl)
{
	int32_t rc = 0;
	uint16_t chipid = 0;
	...
	if (rc < 0) {
		pr_err("%s: %s: hi258_14013 read id failed\n", __func__,
...
static void hi258_14013_set_stauration(struct msm_sensor_ctrl_t *s_ctrl, int value)
{
	pr_debug("%s %d", __func__, value);
	hi258_14013_i2c_write_table(s_ctrl, &HI258_14013_reg_saturation[value][0],
		ARRAY_SIZE(HI258_14013_reg_saturation[value]));
}

static void hi258_14013_set_contrast(struct msm_sensor_ctrl_t *s_ctrl, int value)
{
	pr_debug("%s %d", __func__, value);
	hi258_14013_i2c_write_table(s_ctrl, &HI258_14013_reg_contrast[value][0],
		ARRAY_SIZE(HI258_14013_reg_contrast[value]));
}

static void hi258_14013_set_sharpness(struct msm_sensor_ctrl_t *s_ctrl, int value)
{
	int val = value / 6;
	pr_debug("%s %d", __func__, value);
	hi258_14013_i2c_write_table(s_ctrl, &HI258_14013_reg_sharpness[val][0],
		ARRAY_SIZE(HI258_14013_reg_sharpness[val]));
}


static void hi258_14013_set_iso(struct msm_sensor_ctrl_t *s_ctrl, int value)
{
	pr_debug("%s %d", __func__, value);
	hi258_14013_i2c_write_table(s_ctrl, &HI258_14013_reg_iso[value][0],
		ARRAY_SIZE(HI258_14013_reg_iso[value]));
}

static void hi258_14013_set_exposure_compensation(struct msm_sensor_ctrl_t *s_ctrl,
	int value)
{
	int val = (value + 12) / 6;
	pr_debug("%s %d", __func__, val);
	hi258_14013_i2c_write_table(s_ctrl, &HI258_14013_reg_exposure_compensation[val][0],
		ARRAY_SIZE(HI258_14013_reg_exposure_compensation[val]));
}

static void hi258_14013_set_effect(struct msm_sensor_ctrl_t *s_ctrl, int value)
{
	pr_debug("%s %d", __func__, value);
	switch (value) {
	case MSM_CAMERA_EFFECT_MODE_OFF: {
		hi258_14013_i2c_write_table(s_ctrl, &HI258_14013_reg_effect_normal[0],
			ARRAY_SIZE(HI258_14013_reg_effect_normal));
		break;
	}
	case MSM_CAMERA_EFFECT_MODE_MONO: {
		hi258_14013_i2c_write_table(s_ctrl, &HI258_14013_reg_effect_black_white[0],
			ARRAY_SIZE(HI258_14013_reg_effect_black_white));
		break;
	}
	case MSM_CAMERA_EFFECT_MODE_NEGATIVE: {
		hi258_14013_i2c_write_table(s_ctrl, &HI258_14013_reg_effect_negative[0],
			ARRAY_SIZE(HI258_14013_reg_effect_negative));
		break;
	}
	case MSM_CAMERA_EFFECT_MODE_SEPIA: {
		hi258_14013_i2c_write_table(s_ctrl, &HI258_14013_reg_effect_old_movie[0],
			ARRAY_SIZE(HI258_14013_reg_effect_old_movie));
		break;
	}
	case MSM_CAMERA_EFFECT_MODE_SOLARIZE: {
		hi258_14013_i2c_write_table(s_ctrl, &HI258_14013_reg_effect_solarize[0],
			ARRAY_SIZE(HI258_14013_reg_effect_solarize));
		break;
	}
	default:
		hi258_14013_i2c_write_table(s_ctrl, &HI258_14013_reg_effect_normal[0],
...
static void hi258_14013_set_antibanding(struct msm_sensor_ctrl_t *s_ctrl, int value)
{
	pr_debug("%s %d", __func__, value);
	hi258_14013_i2c_write_table(s_ctrl, &HI258_14013_reg_antibanding[value][0],
		ARRAY_SIZE(HI258_14013_reg_antibanding[value]));
}

static void hi258_14013_set_scene_mode(struct msm_sensor_ctrl_t *s_ctrl, int value)
{
	pr_debug("%s %d", __func__, value);
	switch (value) {
	case MSM_CAMERA_SCENE_MODE_OFF: {
		hi258_14013_i2c_write_table(s_ctrl, &HI258_14013_reg_scene_auto[0],
			ARRAY_SIZE(HI258_14013_reg_scene_auto));
		break;
	}
	case MSM_CAMERA_SCENE_MODE_NIGHT:
	case MSM_CAMERA_SCENE_MODE_NIGHT_PORTRAIT: {
		hi258_14013_i2c_write_table(s_ctrl, &HI258_14013_reg_scene_night[0],
			ARRAY_SIZE(HI258_14013_reg_scene_night));
					break;
	}
	case MSM_CAMERA_SCENE_MODE_LANDSCAPE: {
		hi258_14013_i2c_write_table(s_ctrl, &HI258_14013_reg_scene_landscape[0],
			ARRAY_SIZE(HI258_14013_reg_scene_landscape));
		break;
	}
	case MSM_CAMERA_SCENE_MODE_PORTRAIT: {
		hi258_14013_i2c_write_table(s_ctrl, &HI258_14013_reg_scene_portrait[0],
			ARRAY_SIZE(HI258_14013_reg_scene_portrait));
		break;
	}
	default:
		hi258_14013_i2c_write_table(s_ctrl, &HI258_14013_reg_scene_auto[0],
...
static void hi258_14013_set_white_balance_mode(struct msm_sensor_ctrl_t *s_ctrl,
	int value)
{
	pr_debug("%s %d", __func__, value);
	switch (value) {
	case MSM_CAMERA_WB_MODE_AUTO: {
		hi258_14013_i2c_write_table(s_ctrl, &HI258_14013_reg_wb_auto[0],
			ARRAY_SIZE(HI258_14013_reg_wb_auto));
		break;
	}
	case MSM_CAMERA_WB_MODE_INCANDESCENT: {
		hi258_14013_i2c_write_table(s_ctrl, &HI258_14013_reg_wb_home[0],
			ARRAY_SIZE(HI258_14013_reg_wb_home));
		break;
	}
	case MSM_CAMERA_WB_MODE_DAYLIGHT: {
		hi258_14013_i2c_write_table(s_ctrl, &HI258_14013_reg_wb_sunny[0],
			ARRAY_SIZE(HI258_14013_reg_wb_sunny));
					break;
	}
	case MSM_CAMERA_WB_MODE_FLUORESCENT: {
		hi258_14013_i2c_write_table(s_ctrl, &HI258_14013_reg_wb_office[0],
			ARRAY_SIZE(HI258_14013_reg_wb_office));
					break;
	}
	case MSM_CAMERA_WB_MODE_CLOUDY_DAYLIGHT: {
		hi258_14013_i2c_write_table(s_ctrl, &HI258_14013_reg_wb_cloudy[0],
			ARRAY_SIZE(HI258_14013_reg_wb_cloudy));
					break;
	}
	default:
		hi258_14013_i2c_write_table(s_ctrl, &HI258_14013_reg_wb_auto[0],
...
int32_t hi258_14013_sensor_config(struct msm_sensor_ctrl_t *s_ctrl,
	void __user *argp)
{
	...
	case CFG_SET_INIT_SETTING:
		CDBG("init setting");
		hi258_14013_i2c_write_table(s_ctrl,
				&hi258_14013_recommend_settings[0],
				ARRAY_SIZE(hi258_14013_recommend_settings));
		CDBG("init setting X");
		break;
	case CFG_SET_RESOLUTION: {
		...
		if (val == 0)
			hi258_14013_i2c_write_table(s_ctrl, &hi258_14013_uxga_settings[0],
				ARRAY_SIZE(hi258_14013_uxga_settings));
		else if (val == 1)
			hi258_14013_i2c_write_table(s_ctrl, &hi258_14013_svga_settings[0],
				ARRAY_SIZE(hi258_14013_svga_settings));
		else if (val == 2)
			hi258_14013_i2c_write_table(s_ctrl, &hi258_14013_vga_settings[0],
				ARRAY_SIZE(hi258_14013_vga_settings));
	...
	case CFG_SET_STOP_STREAM:
		CDBG("stop stream");
		hi258_14013_i2c_write_table(s_ctrl,
			&hi258_14013_stop_settings[0],
			ARRAY_SIZE(hi258_14013_stop_settings));
		CDBG("stop stream X");
		break;
	case CFG_SET_START_STREAM:
		CDBG("start stream");
		hi258_14013_i2c_write_table(s_ctrl,
			&hi258_14013_start_settings[0],
			ARRAY_SIZE(hi258_14013_start_settings));
		CDBG("start stream x");
		break;
	...
	case CFG_SET_SATURATION: {
		...
		CDBG("set Saturation");
		hi258_14013_set_stauration(s_ctrl, sat_lev);
	...
	case CFG_SET_CONTRAST: {
		...
		CDBG("set contrast");
		hi258_14013_set_contrast(s_ctrl, con_lev);
		CDBG("set contrast X");
		break;
	}
	case CFG_SET_SHARPNESS: {
		...
		CDBG("set SHARPNESS");
		hi258_14013_set_sharpness(s_ctrl, shp_lev);
	...
	case CFG_SET_ISO: {
		...
		CDBG("set iso");
		hi258_14013_set_iso(s_ctrl, iso_lev);
		CDBG("set iso X");
		break;
	}
	case CFG_SET_EXPOSURE_COMPENSATION: {
		...
		pr_debug("%s: Exposure compensation Value is %d",
			__func__, ec_lev);
		CDBG("set exposure");
		hi258_14013_set_exposure_compensation(s_ctrl, ec_lev);
		CDBG("Set exposure X");
		break;
	}
	case CFG_SET_EFFECT: {
		...
		CDBG("Set effect");
		hi258_14013_set_effect(s_ctrl, effect_mode);
		CDBG("Set effect X");
		break;
	}
	case CFG_SET_ANTIBANDING: {
		...
		hi258_14013_set_antibanding(s_ctrl, antibanding_mode);
	...
	case CFG_SET_BESTSHOT_MODE: {
		...
		CDBG("Set scene mode");
		hi258_14013_set_scene_mode(s_ctrl, bs_mode);
	...
	case CFG_SET_WHITE_BALANCE: {
		...
		CDBG("Set wb");
		hi258_14013_set_white_balance_mode(s_ctrl, wb_mode);
		CDBG("Set wb X");
		break;
	}
	case CFG_GET_YUV_INFO: {
		cdata->cfg.yuv_info.exp_time= hi258_14013_get_exp(s_ctrl);
		cdata->cfg.yuv_info.iso= hi258_14013_get_iso(s_ctrl);
		CDBG("%s exp=%d, iso=%d\n", __func__,
...
static struct msm_sensor_fn_t hi258_14013_sensor_func_tbl = {
	.sensor_config = hi258_14013_sensor_config,
	.sensor_power_up = msm_sensor_power_up,
	.sensor_power_down = hi258_14013_sensor_power_down,
	.sensor_match_id = hi258_14013_sensor_match_id,
};

static struct msm_sensor_ctrl_t hi258_14013_s_ctrl = {
	.sensor_i2c_client = &hi258_14013_sensor_i2c_client,
	.power_setting_array.power_setting = hi258_14013_power_setting,
	.power_setting_array.size = ARRAY_SIZE(hi258_14013_power_setting),
	.msm_sensor_mutex = &hi258_14013_mut,
	.sensor_v4l2_subdev_info = hi258_14013_subdev_info,
	.sensor_v4l2_subdev_info_size = ARRAY_SIZE(hi258_14013_subdev_info),
	.func_tbl = &hi258_14013_sensor_func_tbl,
};

module_init(hi258_14013_init_module);
module_exit(hi258_14013_exit_module);
